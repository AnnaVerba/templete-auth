...
Try add change mode for directory husky
...
**Integration test**:
If you want create integration test, you must create a file ending in *.ispec.ts
...
### Tests works only with this versions libs
